...
class TestChatEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_chat_returns_200_for_valid_query(self, client, mock_pipeline_result):
    ...
    @pytest.mark.asyncio
    async def test_chat_returns_structured_response(self, client, mock_pipeline_result):
    ...
    @pytest.mark.asyncio
    async def test_chat_handles_conversation_history(self, client, mock_pipeline_result):
    ...
    @pytest.mark.asyncio
    async def test_chat_handles_errors_gracefully(self, client):
    ...
    @pytest.mark.asyncio
    async def test_chat_handles_pipeline_not_initialized(self, client):
    ...
    @pytest.mark.asyncio
    async def test_chat_returns_fallback_answer_on_pipeline_error(self, client):
    ...
    async def test_chat_generates_conversation_id_if_not_provided(
        self, client, mock_pipeline_result
    ):
    ...
    @pytest.mark.asyncio
    async def test_chat_preserves_conversation_id_if_provided(self, client, mock_pipeline_result):
