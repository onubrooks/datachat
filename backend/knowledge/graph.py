...
Supports tables, columns, metrics, and their connections.
"""
...
class KnowledgeGraph:
    ...
    Builds a directed graph of tables, columns, metrics, and processes
    ...
    def add_datapoint(self, datapoint: DataPoint) -> int:
        ...
        Args:
            datapoint: DataPoint to add (Schema, Business, or Process)
